...
| **2. A direção da semana** | Os cartões de direção (`pedidos-de-entrada-por-semana`, `liberacoes-em-48h`) com a meta da semana e a sequência; o compromisso como registro com `vence_em_dias: 7`; o veredito da semana passada calculado; o bloco 3 da capa. | o livro, `leads`, `alunos` | 0 |
