...
for SERVICO in catalogo alunos; do
...
# -----------------------------------------------------------------------------
echo "== 2/4: descobrindo de qual escola sao as matriculas =="
...
# -----------------------------------------------------------------------------
echo
echo "== 3/4: cadastrando os dois cursos =="
...
# -----------------------------------------------------------------------------
echo
echo "== 4/4: apontando as matriculas de hoje para '$NOME_1' =="
echo
...
echo
echo "O curso do livro ('$NOME_2') ainda nao tem nenhum aluno, e e o proximo:"
echo "voce escolhe esse curso na hora de liberar alguem, em"
