...
# (slug, nome, descricao, classe, familia, criterio, faixa_etaria,
#  envolve_dinheiro, exige_validador_adulto, secreta, pontos, cristais)
CONQUISTAS = [
    (
        "fundador",
        "Fundador",
    ...
    (
        "primeiro-cliente",
        "Primeiro cliente",
        "Alguém pediu uma peça para você fazer. Com ajuda do responsável.",
        "marco",
        "carreira",
        {"tipo": "manual"},
        "13mais",
    ...
    (
        "primeiros-dolares",
        "Primeiros dólares",
        "O primeiro dinheiro que o seu trabalho trouxe. Sempre com um adulto junto.",
        "marco",
        "carreira",
        {"tipo": "manual"},
        "13mais",
