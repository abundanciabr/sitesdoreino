...
# silenciosa: nada aqui renderiza data hoje, e o erro só apareceria no dia em que
# o primeiro corpo de e-mail carregasse um horário — e aí quem descobre é o
# destinatário, num texto que já saiu da plataforma e não se corrige mais. Foi
# assim que a `sugestoes` foi pega em 24/08/2026 (EVO-21). Receita completa:
# armadilhas/099. Apague a linha `TIME_ZONE` do `config/settings.py` e estes dois
