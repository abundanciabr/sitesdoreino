...
# AGORA. A `mensageria` é `not-applicable` em `ci/manifesto-de-contratos.json`,
# e continua sendo depois deste PR. O contrato entra no degrau 6d, PR à parte,
# com a etiqueta `contrato` e o mantenedor presente; é a saída DESTE comando que
# vira o `contracts/mensageria.openapi.yaml` daquele PR.
#
...
# morreu no `make ci` até a porta subir. Ver `armadilhas/228`.
import json
