...
# (`armadilhas/INDICE.md` → §5.3). O default é inofensivo: a conexão do Huey é
# preguiçosa e só o worker (`run_huey`) de fato conecta; faltando a variável de
# verdade, quem falha alto é o worker, no log dele.
...
huey = RedisHuey("sugestoes", url=HUEY_REDIS_URL)
