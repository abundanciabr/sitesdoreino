...
> (`/admin/caixa/robos/`, `services/admin/apps/core/robos.py`, PR #520). A
> lição acima fica como estava: recusar a tela sem fonte foi o que garantiu
> que ela nascesse cheia, um dia depois — e não vazia, um dia antes.
