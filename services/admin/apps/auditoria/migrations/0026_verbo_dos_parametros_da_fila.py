"""O verbo de mudar um numero da Fila do Primeiro Dolar (07/09/2026).

A tela `/admin/encomendas/parametros/`, do degrau 2.14 da
`DECISAO-fila-do-primeiro-dolar.md`. Mexe so nas ESCOLHAS do campo, como as
...
# Generated by Django 5.1.4 on 2026-09-07 07:03
"""
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("auditoria", "0025_verbo_de_cancelar_tarefa"),
    ]
