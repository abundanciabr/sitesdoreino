"""O verbo da estrutura do curso: colar os modulos e as aulas de uma vez.

A tela `/admin/escola/<curso>/estrutura/` (TAR-272), da
`DECISAO-a-sala-serve-varios-cursos.md` §4. Mexe so nas ESCOLHAS do campo, como
as migracoes de verbo anteriores desta tabela: nenhuma linha existente muda, e o
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("auditoria", "0027_verbos_do_curso"),
    ]
