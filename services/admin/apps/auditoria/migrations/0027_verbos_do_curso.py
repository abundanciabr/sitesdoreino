"""Os dois verbos do curso: criar um, e trocar o produto ou a regra dele.

A tela `/admin/escola/cursos/` (TAR-271), da
`DECISAO-a-sala-serve-varios-cursos.md`. Mexe so nas ESCOLHAS do campo, como as
migracoes de verbo anteriores desta tabela: nenhuma linha existente muda, e o
gatilho de append-only continua de pe (`armadilhas/246`).

# Generated by Django 5.1.4 on 2026-09-07 17:45
"""
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("auditoria", "0026_verbo_dos_parametros_da_fila"),
    ]
