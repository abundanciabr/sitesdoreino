"""O verbo de tirar uma tarefa da fila (`/admin/caixa/robos/`, 06/09/2026).

Mexe só nas ESCOLHAS do campo, como as migrações de verbo anteriores desta
tabela: nenhuma linha existente muda, e o gatilho de append-only continua de pé
(`armadilhas/246`).

# Generated by Django 5.1.4 on 2026-09-07 02:05
"""
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("auditoria", "0024_verbo_de_criar_livro"),
    ]
