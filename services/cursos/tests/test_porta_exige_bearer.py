...
AS_ONZE = [
    ...
    ("listLessons", "get", f"/cursos/meshcraft/aulas?site_id={SITE}", None),
    ("getLesson", "get", f"/cursos/meshcraft/aulas/E00?site_id={SITE}&parte=1", None),
    (
        "putLesson",
        "put",
        f"/cursos/meshcraft/aulas/E00?site_id={SITE}&parte=1",
        CORPO_DA_AULA,
    ),
    (
        "publishLesson",
        "post",
        f"/cursos/meshcraft/aulas/E00/publicar?site_id={SITE}&parte=1",
        None,
    ),
