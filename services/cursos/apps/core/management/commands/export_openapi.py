...
#
# Este comando nasce JUNTO com a porta (degrau 1.3), e o contrato congela DEPOIS
# (degrau 1.4), a partir do que ele imprime. É a ordem que `armadilhas/228` e
# `243` provaram: congelar antes do exportador deixa o `make ci` da célula em
# ERROR ("Unknown command: 'export_openapi'") em todo PR seguinte.
#
