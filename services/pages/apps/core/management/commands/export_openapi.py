...
#
# Cópia do PADRÃO de `gamificacao`/`notificacoes`/`alunos` (Lei 3: copia-se o
...
#
# Este comando nasce JUNTO com a porta (degrau 03 da escada do
# `PLANO-PORTFOLIO-DO-ALUNO.md` §5), e o contrato congela DEPOIS, em PR próprio,
# a partir do que ele imprime. É a ordem que `armadilhas/228` e `243` provaram:
# congelar antes do exportador deixa o `make ci` da célula em ERROR ("Unknown
# command: 'export_openapi'") em todo PR seguinte. E a cerca
