...
api = NinjaAPI(
    ...
    description=(
        ...
        "\n"
        "AS OPERACOES /areas, /topicos/recentes E /resumo SO RESPONDEM SOBRE AREA\n"
        "PUBLICA. Area de aluno e area de turma nao aparecem nelas, nem o conteudo,\n"
        "nem a contagem, nem a existencia.\n"
        "\n"
        "A UNICA EXCECAO E /galeria/candidatas/{pessoa_id}. Ela existe apenas para\n"
        "o par gamificacao e forum consultar referencias consentidas da propria\n"
        "autora, no escopo de um site, sem tornar o topico original publico. O\n"
        "Bearer identifica o servico, nunca a pessoa. O Forum confere que cada\n"
        "candidata e do `pessoa_id` pedido; a gamificacao, com sessao, confere que\n"
        "quem consulta so pede as proprias candidatas.\n"
        "\n"
