...
* **O fórum não resolvia site nenhum até agora.** Ele não tem o CONV-SITE
  inteiro (isso seria uma mudança bem maior que um menu, e mexeria em toda a
  identidade da célula): ele pergunta ao catálogo APENAS o menu do host da
...
errada — e é a mesma escolha que o `_sessao.html` do site já faz com o sino.
"""
...
logger = logging.getLogger("forum.menu")
