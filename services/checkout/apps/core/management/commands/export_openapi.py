...
def _strip_redundant_operation_noise(schema: dict) -> None:
    ...
    de path. O contrato congelado só declara essas informações uma vez. Também
    emite "parameters": [] para operações sem parâmetro algum (ex.: createSession)
    — o contrato congelado simplesmente omite a chave nesse caso."""
