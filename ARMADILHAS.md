...
Agente, aqui, é quem constrói pela ficha de despacho. A sessão responsável
define o brief e julga as lições; o subagente segue a competência da ficha.
Nenhuma marca de IA recebe um papel fixo.
...
| `ARMADILHAS-OPERACAO.md` | **sessão responsável e mantenedor** | §1 precisa-de-você · como se mergeia · painéis · §9 dívidas abertas |
