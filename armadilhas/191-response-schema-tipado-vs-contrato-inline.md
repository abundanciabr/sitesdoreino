...
**Nota do resgate (30/08/2026).** Esta entrada ficou tres dias parada no PR #287, vermelha e sozinha: ela nasceu com o numero `141`, e enquanto o PR esperava, outra sessao mergeou uma entrada diferente com o MESMO `141` — o gerador passou a reprovar por numero repetido, e o PR nao tinha como destravar sozinho. E a `armadilhas/085` cobrando, e e exatamente o que a `armadilhas/189` mediu duas vezes no mesmo dia. O numero `191` desta versao foi **pedido ao almoxarife**, e desde 30/08/2026 isso deixou de ser conselho: `ci/muralha-das-reservas.sh` recusa entrada nova com numero escolhido a mao. O conteudo abaixo e o original, intacto — so o numero mudou.
