(function(){ (window.REGISTROS = window.REGISTROS || []).push({
  ...
  autoridade: "rito",
  evidencia: "PR https://github.com/abundanciabr/sitesdoreino/pull/723 (TAR-082, degrau D). O script tem 6 testes que o EXECUTAM contra uma plataforma de mentira, e um deles prova que a metade secreta nunca aparece na saida.",
