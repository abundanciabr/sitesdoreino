(function(){ (window.REGISTROS = window.REGISTROS || []).push({
  ...
  autoridade: "sessao",
  evidencia: "https://github.com/abundanciabr/sitesdoreino/pull/609 — este PR, com a TAR-029 e este registro. MEDIDO por robos diferentes, sempre por 'gh run view --json' e nunca por cano: o robo da TAR-024 contou 2 cancelados contra 20 sucessos no deploy-infra, os dois nos merges dos PRs 602 e 605, ambos em 30/08/2026, e esperou vaga livre em vez de expulsar o deploy de outro robo. Os outros dois casos estao em armadilhas/188 (PR 558, 30/08, deploy-celula) e armadilhas/183 (PR 527, 29/08, deploy-celula). A causa da briga: os dois workflows compartilham o grupo de concorrencia 'deploy', e todo PR carrega registro em painel/registros/, que casa 'painel/**' e dispara o deploy-celula. O remedio que existe e nao tem gatilho e o ci/rerun_de_deploy.py, ensinado a tratar o cancelado por push hoje pela TAR-017 (PR 573).",
