(function(){ (window.REGISTROS = window.REGISTROS || []).push({
  ...
  autoridade: "github",
  evidencia: "https://github.com/abundanciabr/sitesdoreino/pull/1124 (PR #1124). pytest tests/test_inv_l4_a_ia_nao_decide.py -> 7 passed contra o codigo ja em producao; sabotagem (campo decisao no dataclass) -> 2 failed nas assercoes; desfeita -> 7 passed. ci/ci.py --apenas guardas -> PASS; test_guarda_dos_guardas.py -> 47 passed.",
