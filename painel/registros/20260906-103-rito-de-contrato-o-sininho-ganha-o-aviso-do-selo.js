(function(){ (window.REGISTROS = window.REGISTROS || []).push({
  arquivo: "20260906-103-rito-de-contrato-o-sininho-ganha-o-aviso-do-selo",
  tipo: "decisao",
  quando: "2026-09-06",
  ...
  frente: "site",
  vence_em_dias: null,
  se_eu_nao_decidir: "A TAR-187 fica parada. O selo da escola continua funcionando na tela, mas o aluno não fica sabendo que foi conferido, a menos que abra a página do portfólio dele.",
  recomendacao: "Liberar. É acrescentar uma frase ao arquivo que transforma assunto em texto de tela, na mesma parte onde já moram as frases dos outros oito avisos. Não toca dado de ninguém e não muda nenhuma outra tela.",
  reversivel: true,
  impacto: "baixo"
});})();
