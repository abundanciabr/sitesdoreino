(function(){ (window.REGISTROS = window.REGISTROS || []).push({
  ...
  evidencia: "https://github.com/abundanciabr/sitesdoreino/pull/387. Fonte: captura do painel da Hostinger enviada pelo mantenedor em 28/08/2026, mais a ficha do plano KVM 1 (1 vCPU, 4 GB RAM, 50 GB NVMe, 4 TB) e a do KVM 2 (2 vCPU, 8 GB, 100 GB, 8 TB), ambas enviadas por ele. Numero deste registro alocado pelo servidor via ci/reservar.py (Onda 2), nao adivinhado.",
