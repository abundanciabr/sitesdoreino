(function(){ (window.REGISTROS = window.REGISTROS || []).push({
  ...
  autoridade: "github",
  evidencia: "PR https://github.com/abundanciabr/sitesdoreino/pull/758. 8 testes novos, um por modo de falha do comando: so-de-olhar nao envia, sem chave ele avisa em vez de fingir, recusa do servidor aparece como nao-saiu, aparelho morto sai do banco, o teste nao grava carta, e o endereco do aparelho sai cortado na tela (armadilhas/090). 144 verdes na celula (as duas de indice exigem Postgres e rodam no CI).",
