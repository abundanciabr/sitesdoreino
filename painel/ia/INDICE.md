...
| 04 | [Arquitetura de Células e Contratos](04-arquitetura-de-celulas-e-contratos.md) | O padrão de célula, tabela das 12 células, o mecanismo de contratos (OpenAPI + eventos) e o isolamento entre células | ...entender ou mudar uma célula específica, ou mexer em `contracts/` |
