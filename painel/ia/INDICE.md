...
("Curso Esqueleto", R$9,90). É construído com assistência de IA, por tarefas delimitadas
pelas leis descritas em [01](01-leis-ritos-e-invariantes.md), para um mantenedor
que é leigo em código e terminal: essa
