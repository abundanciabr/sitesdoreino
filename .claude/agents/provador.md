...
`reversivel` e `impacto` preenchidos. Depois devolva à sessão responsável. Abrir exceção é
...
que está aberta e devolva à sessão responsável. O contêiner da bancada marca UTC, então
