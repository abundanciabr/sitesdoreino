...
por isso toda ficha nega `Agent`. E quem pergunta ao mantenedor é a sessão responsável; o
...
bloqueio que ele devolve vira o bloco **Instruções** da sessão responsável, que é o que o
